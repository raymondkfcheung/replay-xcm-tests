...
async function main() {
    ...
    // await api.tx.PolkadotXcm.transfer_assets_using_type_and_then({
    //     dest: XcmVersionedLocation.V5( /* Hydration */),
    //     assets: XcmVersionedAssets.V5([ /* DOT */]),
    //     fee_asset_item: 0,
    //     reserve_transfer_type: TransferType.RemoteReserve( /* AssetHub */),
    //     xcm_on_dest: VersionedXcm.V5([
    //         BuyExecution(...),
    //         SwapInstruction(...), // custom swap
    //         DepositAsset(...)
    //     ]),
    //     weight_limit: XcmV3WeightLimit.Limited({ /* some reasonable limit */ }),
    // });
